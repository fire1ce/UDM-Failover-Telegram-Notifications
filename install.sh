...
curl -O https://raw.githubusercontent.com/fire1ce/UDMP-Failover-Telegram-Notifications/main/99-failover-telegram-notifications.sh
mv 99-failover-telegram-notifications.sh $on_boot_script
chmod +x $on_boot_script
echo "$on_boot_script installed"

curl -O https://raw.githubusercontent.com/fire1ce/UDMP-Failover-Telegram-Notifications/main/failover-notifications.sh
